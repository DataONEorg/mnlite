...
- Report a bug or request a new feature in our [issue tracker](https://github.com/DataONEorg/mnlite/issues)
...
mnlite is an open source project, and we welcome full
participation in the project.  Contributions are reviewed and suggestions are
made to increase the value of mnlite to the community.  We strive to
...
- add an [issue](https://github.com/DataONEorg/mnlite/issues) describing your planned changes, or add a comment to an existing issue;
- on GitHub, fork the [mnlite repository](https://github.com/DataONEorg/mnlite)
- on your computer, clone your forked copy of the mnlite repository
...
Development is managed through the git repository at https://github.com/DataONEorg/mnlite.  The repository is organized into several branches, each with a specific purpose.  
...
3. Releases can be downloaded from the [GitHub releases page](https://github.com/DataONEorg/mnlite/releases).

## Testing

**Unit and integration tests**. mnlite has a full suite of `pytest` tests in the `tests` subdirectory.
