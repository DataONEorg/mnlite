...
def getLogRecords():
    from_date = flask.request.args.get("fromDate", None)
    to_date = flask.request.args.get("toDate", None)
...
def systemMetadataChanged():
    ...
    date_modified = flask.request.files.get("dateSysMetaLastModified", None)
